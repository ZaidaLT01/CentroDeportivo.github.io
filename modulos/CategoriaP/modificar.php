			...
			<div class="row">
				...
				<div class="col-12 col-xs-10 col-sm-10	col-md-10	col-lg-10 col-xl-10"> 
					<div id="cuerpo">
						<div class="container">
							<br>
							<H2><span class="label label-info">MODIFICAR REGISTRO PRODUCTO SNACK</span></H2>
							<hr>
						...
						<?php
								$consulta="select * from categoriap where id_categoria='$cod'";
								$res=mysqli_query($conexion,$consulta);
							while ($fila=mysqli_fetch_array($res)) {
								echo '<tr>';
								echo'
								<form method="POST" action=modificar.php?cod='.$fila['id_categoria'].'>
								<tr>
